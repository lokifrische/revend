...
export const metadata: Metadata = {
  ...
  description:
    'Find out what your iPhone, Samsung, or Google phone is worth today. Compare buyback prices instantly. Free, no sign-up.',
}
...
export default async function PriceCheckPage() {
  const popularFamilies = await getPopularFamilies(8)
  const popularLookups = popularFamilies.map(dbFamilyToDevice)
      ...
      <main className="flex-1 pt-20">
        ...
        <section className="bg-navy-800 text-white py-16 px-4">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-4xl sm:text-5xl font-bold mb-5">What is my phone worth?</h1>
            <p className="text-slate-300 text-lg mb-8">
              Find out in seconds. Compare live offers from 7+ verified buyers — and see how your
              device&apos;s value has changed over time.
            </p>
        ...
        <section className="py-14 px-4 bg-slate-50">
          <div className="max-w-5xl mx-auto">
            ...
            <p className="text-slate-500 text-sm mb-6">
              Device values drop every month — especially around new model launches. Here&apos;s how
              trade-in values change over time for the most popular devices.
            </p>
                ...
                <table className="w-full">
                  ...
                  <tbody>
                    {depreciationData.map((row, i) => {
                      const drop2yr = Math.round(
                        ((row.launch - row.after24m) / row.launch) * 100,
                      )
                      return (
                        <tr
                          key={i}
                        ...
                        >
                          ...
                          <td className="px-4 py-4 text-right text-sm text-slate-600">
                            ${row.launch.toLocaleString()}
                          </td>
                          <td className="px-4 py-4 text-right text-sm font-medium text-teal-600">
                            ${row.after6m}
                          </td>
                          <td className="px-4 py-4 text-right text-sm text-slate-600">
                            ${row.after12m}
                          ...
                          <td className="px-4 py-4">
                            <Link
                              href="/#search"
                              className="text-xs text-teal-600 hover:text-teal-700 font-medium whitespace-nowrap flex items-center gap-1"
                            >
            ...
            <div className="flex items-start gap-2 mt-3">
              ...
              <p className="text-xs text-slate-400">
                Trade-in values shown are estimates based on current buyback market averages. Actual
                offers may vary based on condition and buyer. Compare live offers for exact prices.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-amber-50 border border-amber-200 rounded-2xl p-6">
              <h3 className="text-base font-bold text-amber-800 mb-2">
                💡 Pro tip: Sell before the next model launches
              </h3>
              <p className="text-sm text-amber-700 leading-relaxed">
                Device values typically drop 15–25% in the month after a new model is announced. If
                you&apos;re thinking of selling, doing it before the next iPhone or Galaxy
                announcement can mean hundreds of dollars more.
              </p>
              <Link
                href="/blog/best-time-to-sell-iphone"
        ...
        <section className="py-16 px-4 bg-navy-800">
          <div className="max-w-xl mx-auto text-center text-white">
            ...
            <p className="text-slate-400 mb-8">
              Live prices from 7+ verified buyers. Free, instant, no sign-up needed.
            </p>
