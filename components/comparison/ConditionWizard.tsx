...
interface ConditionWizardProps {
  ...
  /** Pass conditions from the server to use real DB data; falls back to static list */
...
export default function ConditionWizard({
  ...
  const conditionList = conditions ?? defaultConditions

  return (
    <div className="space-y-4">
      <div>
        <h3 className="text-base font-semibold text-navy-800 mb-1">
          What condition is your device?
        </h3>
        <p className="text-sm text-slate-500">
          Be honest — buyers verify condition on arrival. Select the closest match.
        </p>
      </div>
