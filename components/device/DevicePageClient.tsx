...
import { ChevronRight, Star, Package, Clock } from 'lucide-react'
...
import { Device, getOffersForDevice, popularDevices } from '@/lib/data'
              ...
              <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden">
                <div className="aspect-square bg-gradient-to-br from-slate-50 to-slate-100 flex items-center justify-center p-6 relative">
                  {!imgError && device.image ? (
                    <Image
                      src={device.image}
                      alt={`${device.name} — sell for up to $${device.maxOffer}`}
                      width={280}
                      height={280}
